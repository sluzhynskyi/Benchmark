...
int main(int argc, char **argv)
{
    ...
    case 2:
        ...
        break;
    case 3:
        method_description = "in.read(s[0], s.size())";
    ...
    std::ofstream out(file_out, std::ios::app);
    if (!out)
    {
        cerr << "Error opening file" << endl;
        return 1;
    }
    out << method_description << ": " << symbols << std::endl;

    std::cout << "Reading file using " << method_description << " (microseconds):" << std::endl
              << to_us(duration);
